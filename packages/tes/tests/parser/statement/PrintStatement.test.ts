...
describe('Given: Print statement', () => {
    describe('Given: Incorrect syntax', () => {
        it('Return parser error', () => {
            Tes.reset()
            const tokens = new Lexer(`print`).lex()
        ...
        it('Return parser error', () => {
            Tes.reset()
            const tokens = new Lexer(`print for `).lex()
        ...
        it('Return parser error', () => {
            Tes.reset()
            const tokens = new Lexer(`print 1`).lex()
    ...
    describe('Given: Correct syntax', () => {
        it('Return program', () => {
            Tes.reset()
            const tokens = new Lexer(`print 2 + 4 and 3;`).lex()
